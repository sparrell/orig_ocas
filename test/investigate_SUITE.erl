...
%%%-------------------------------------------------------------------
%% @doc test investigate action
%% @end
%%%-------------------------------------------------------------------

-module(investigate_SUITE).
...
-include_lib("./include/investigate01.hrl").
-include_lib("./include/investigate_wo_target.hrl").

%% tests to run
all() ->
    [ test_investigate
    , test_bad_investigate
    ].
