...
%%%-------------------------------------------------------------------
%% @doc test restore action
%% @end
%%%-------------------------------------------------------------------

-module(restore_SUITE).
...
-include_lib("./include/restore01.hrl").
-include_lib("./include/restore_wo_target.hrl").
