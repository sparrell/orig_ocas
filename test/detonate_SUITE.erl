...
%%%-------------------------------------------------------------------
%% @doc test detonate action
%% @end
%%%-------------------------------------------------------------------

-module(detonate_SUITE).
...
-include_lib("./include/detonate01.hrl").
-include_lib("./include/detonate_wo_target.hrl").
