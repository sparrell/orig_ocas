...
%%%-------------------------------------------------------------------
%% @doc test substitute action
%% @end
%%%-------------------------------------------------------------------

-module(substitute_SUITE).
...
-include_lib("./include/substitute01.hrl").
-include_lib("./include/substitute_wo_target.hrl").
...
test_substitute(_Config) ->
    ...
    ExpectedJsonPairs = [ {<<"has_http_body">>, true}
                        ...
                        , {<<"has_action">>, true}
                        , {<<"action">>, <<"substitute">>}
                        , {<<"action_server">>, <<"substitute_server">>}
                        , {<<"action_valid">>, true}
                        , {<<"has_actuator">>, true}
                        , {<<"has_modifiers">>, true}
                        , {<<"has_target">>, true}
